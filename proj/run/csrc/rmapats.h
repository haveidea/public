...
struct iptmpl {
    QIRD  * I640;
    struct vcs_globals_t * I641;
    void * I643;
    UP  I644;
    UP  I645;
    struct iptmpl * I636[2];
};
typedef unsigned long long FileOffset;
typedef struct _hsimPeriodL {
    char  I802[256];
    struct _hsimPeriodL * I772;
} HsimPeriodL;
typedef struct {
    U   I804[2];
    U  I805 :1;
...
typedef struct TableAssign_ {
    struct TableAssign_ * I772;
    struct TableAssign_ * I692;
    U  I5;
    U  iinput;
    RP  ptable;
    RP  I866;
...
struct dummyq_struct {
    ...
    struct futq * I934;
    struct futq * I935;
    struct sched_table * I936;
    struct millenium * I938;
    EBLK  * I940;
    EBLK  * I941;
    EBLK  * I942;
    EBLK  * I943;
...
void  hsM_10_0(UB  * pcode, vec32  * I840, U  I780);
void  hsM_11_0(UB  * pcode, scalar  val);
void  hsM_11_5(UB  * pcode, UB  val);
void  hsM_12_0(UB  * pcode, vec32  * I840, U  I780);
...
void  hsM_15_0(UB  * pcode, vec32  * I840, U  I780);
void  hsM_15_5(UB  * pcode, U  I780);
void  hsM_16_0(UB  * pcode, scalar  val);
void  hsM_16_5(UB  * pcode, UB  val);
void  hsG_0(struct dummyq_struct * I970, EBLK  * I971, U  I701);
#ifdef __cplusplus
}
#endif
